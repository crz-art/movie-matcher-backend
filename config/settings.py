...
SECRET_KEY = 'django-insecure-rxw=pc3bhuqz+uik8+hklofnq1myirr6qka$w^%gq^!k1du4!)'
...
INSTALLED_APPS = [
    ...
    # Aplicaciones instaladas para la API y Base de Datos
    'rest_framework',
    'corsheaders',
    'core',
]
...
# Configuración Inteligente de Base de Datos (PostgreSQL en Render / SQLite local)
...
# Permitir solicitudes desde React Frontend
